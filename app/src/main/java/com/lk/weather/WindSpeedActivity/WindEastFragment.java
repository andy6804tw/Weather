 ...
 */
public class WindEastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_wind_east, container, false);
        //設定RecyclerView
    ...
    final private android.support.v7.widget.SearchView.OnQueryTextListener queryListener = new android.support.v7.widget.SearchView.OnQueryTextListener() {
        ...
        public boolean onQueryTextChange(String newText) {
            ...
            for(int i=0;i<c.getCount();i++){
                c2.moveToFirst();
                c2.move(Integer.parseInt(c.getString(7))-1);
                if(c2.getString(5).equals("東部")&&c2.getString(1).contains(newText)){
